...
func (r *Resolver) CreateUserResolver(ctx context.Context, username string, password string, email string, sex string, dateOfBirth string) (*model.MutationResponse, error) {
...
func (r *Resolver) LoginUserResolver(ctx context.Context, username string, password string) (bool, error) {
	gc, err := GinContextFromContext(ctx)
	if err != nil {
...
func (r *Resolver) GetUserResolver(ctx context.Context, username string) (int, error) {
	gc, err := GinContextFromContext(ctx)
	if err != nil {
...
func (r *Resolver) UpdateUserResolver(ctx context.Context, username string, updateName string, email string) (*model.MutationResponse, error) {
	gc, err := GinContextFromContext(ctx)
	if err != nil {
		return nil, fmt.Errorf("gin context convert error: %v", err)
	}
...
func (r *Resolver) DeleteUserResolver(ctx context.Context, username string) (*model.MutationResponse, error) {
	gc, err := GinContextFromContext(ctx)
	if err != nil {
		return nil, fmt.Errorf("gin context convert error: %v", err)
	}
