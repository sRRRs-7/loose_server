...
func (r *mutationResolver) GetAllCodesByTagsResolver(ctx context.Context, tags []*string, sortBy model.SortBy, first int, skip int) ([]*model.Code, error) {
	gc, err := GinContextFromContext(ctx)
	if err != nil {
		return nil, fmt.Errorf("gin context convert error: %v", err)
	}
...
func (r *Resolver) GetAllCodesResolver(ctx context.Context, first int, skip int) ([]*model.Code, error) {
