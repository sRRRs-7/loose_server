...
func (r *mutationResolver) GetAllCodesByTag(ctx context.Context, tags []*string, sortBy model.SortBy, limit int, skip int) ([]*model.Code, error) {
...
func (r *mutationResolver) GetAllCodesByKeyword(ctx context.Context, keyword string, limit int, skip int) ([]*model.Code, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *mutationResolver) GetAllCodesSortedStar(ctx context.Context, limit int, skip int) ([]*model.Code, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *mutationResolver) GetAllCodesSortedAccess(ctx context.Context, limit int, skip int) ([]*model.Code, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) GetCollection(ctx context.Context, id int) (*model.Code, error) {
...
func (r *queryResolver) GetAllCodes(ctx context.Context, limit int, skip int) ([]*model.Code, error) {
	res, err := r.GetAllCodesResolver(ctx, first, skip)
	if err != nil {
...
func (r *queryResolver) GetAllCollection(ctx context.Context, limit int, skip int) ([]*model.CodeWithCollectionID, error) {
	res, err := r.GetAllCollectionResolver(ctx, first, skip)
	if err != nil {
...
func (r *mutationResolver) GetAllCodesByTags(ctx context.Context, tags []*string, sortBy model.SortBy, first int, skip int) ([]*model.Code, error) {
	res, err := r.GetAllCodesByTagsResolver(ctx, tags, sortBy, first, skip)
	if err != nil {
		return nil, fmt.Errorf("GetAllCodesByTags error: %v", err)
	}
	return res, nil
}
