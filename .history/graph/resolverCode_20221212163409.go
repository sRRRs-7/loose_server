...
func (r *Resolver) GetAllCodesByTagResolver(ctx context.Context, tags []*string, sortBy model.SortBy, first int, skip int) ([]*model.Code, error) {
	gc, err := GinContextFromContext(ctx)
	if err != nil {
		return nil, fmt.Errorf("gin context convert error: %v", err)
	}
...
func (r *Resolver) GetAllCodesByKeywordResolver(ctx context.Context, keyword string, limit int, skip int) ([]*model.Code, error) {
}
