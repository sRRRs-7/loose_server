...
func (r *mutationResolver) GetAllCodesSortedStarResolver(ctx context.Context, limit int, skip int) ([]*model.Code, error) {
}

func (r *mutationResolver) GetAllCodesSortedAccessResolver(ctx context.Context, limit int, skip int) ([]*model.Code, error) {
}
